...
- **The sender made it before you had FileKey.** Set up at filekey.app, then use **Send me a file** to get your personal link and pass it to the sender. When they send through your link, the new file is locked to you and will open.
...
**Does it work on iPhone and Android?** Yes. FileKey runs in the browser on phones, tablets, and computers, and supports Safari on iPhone.
