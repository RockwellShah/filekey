...
Nothing uploads to FileKey, there's no account to create, and the encryption is the same public-key cryptography (HPKE with AES-256) used by modern secure messengers. If you're curious how a fingerprint becomes an encryption key, we wrote up [the full technical path](/blog/introducing-filekey/).
